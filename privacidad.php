...
<head>
    ...
    <title>PRIVACIDAD DE DATOS - OZUTECH</title>
</head>
<body>
    <center>
    <H1>PRIVACIDAD DE DATOS</H1>
    <p>OzuTech, es el responsable del uso y protección de sus datos personales, y al respecto le informamos lo siguiente:
(SE AVISA QUE NUNCA SE PEDIRÁ NI DIRECCIÓN PERSONAL NI DATOS QUE USTED NO QUIERA APORTAR. NOSOTROS SOLO TE PEDIREMOS: EL NOMBRE, APELLIDOS(OPCIONAL) Y UNA CONTRASEÑA QUE USTED QUIERA. TAMBIÉN SE PUEDE PONER UN USUARIO PARA IDENTIFICARLE EN LOS RANKINGS DE LOS JUEGOS)
¿Para qué fines utilizaremos sus datos personales?
Los datos personales que recabamos de usted, los utilizaremos para las siguientes finalidades que son necesarias para el servicio que solicita:
Utilizamos sus datos para poder identificarte a la hora de jugar para guardar tu progreso.
<br><br>
...
Para el ejercicio de cualquiera de los derechos ARCO, debe enviar una petición vía correo electrónico a ozugames.online@gmail.com y deberá contener:
<br>
